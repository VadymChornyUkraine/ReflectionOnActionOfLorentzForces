                        ...
                        while hhhx<int(NIter/5):
                            ...
                            for ii in range(aNN):   
                                for jj in range(aMM):
                                    ...
                                    DD__=DD_[int(ii*anI/aNN):int((ii+1)*anI/aNN),int(jj*Nf/aMM):int((jj+1)*Nf/aMM)].copy()
                                    if len(dd1)>1 and len(dd1[0])>=len(dd1):
                                        eeA= XFilter.RALF1FilterX( dd1*(1-seqA_)+seqA_*( dd1-(DD__)),len(dd1),len(dd1[0]),1,0)
                                        eeB=-XFilter.RALF1FilterX(-dd1*(1-seqA_)+seqA_*(-dd1-(DD__)),len(dd1),len(dd1[0]),1,0)
                                    ...
                                    dd1=0.5*(dd_AA+dd_BB)[int(ii*anI/aNN):int((ii+1)*anI/aNN),int(jj*Nf/aMM):int((jj+1)*Nf/aMM)]
                                    seqB=(dd1.reshape(len(dd1)*len(dd1[0])))[1:]*np.ceil(0.5*(1/(mdd4_.reshape(len(dd1)*len(dd1[0]))==1)[0:len(dd1)*len(dd1[0])-1]+1/(mdd4_.reshape(len(dd1)*len(dd1[0]))==1)[1:]))
                                    ...
                                    try:
                                        if P[0]>0 and 100*scp.pearsonr(seqA,seqB)[0]>50:
                                            dd_CC[int(ii*anI/aNN):int((ii+1)*anI/aNN),int(jj*Nf/aMM):int((jj+1)*Nf/aMM)]=(dd1.copy()-P[1])/P[0] 
                                        else:
                                            PP=0
                                    except:
                                        PP=0
                                    # dd_CC[int(ii*anI/aNN):int((ii+1)*anI/aNN),int(jj*Nf/aMM):int((jj+1)*Nf/aMM)]=(dd1.copy())
                            ...
                            # if P[0]>0 and 100*scp.pearsonr(seq0,seq0_)[0]>60:
                            #     dd_CC=(dd_CC-P[1])/P[0] 
