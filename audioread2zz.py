            ...
            for iGr in range(Ngroup):                
                ...
                if anI>aNN:   
                    ...
                    for hhhx in range(anI):
                        ...
                        if not aStrx==np.Inf:
                            ddx=dd.reshape((anI*Nf))+aStrx
                            dd=(np.cumsum(ddx)).reshape((anI,Nf))
                        for i in range(anI):
                ...
                if Lo:
                    if aStr==np.Inf:
                        ...
                        arr_RezM[iGr]=filterFourierQ(np.cumsum(all_RezM[iGr][hhhx]),np.log(arr_z),NNew,1)
                    ...
                    if aStr==np.Inf:
                        ...
                        arr_RezM[iGr]=filterFourierQ(np.cumsum(all_RezM[iGr][hhhx]),(arr_z),NNew,1)
                ...
                if Lo:
                    if aStr==np.Inf:
                        ...
                        arr_RezN[iGr]=filterFourierQ(np.cumsum(all_RezN[iGr][hhhx]),np.log(arr_z),NNew,1)
                    ...
                    if aStr==np.Inf:
                        ...
                        arr_RezN[iGr]=filterFourierQ(np.cumsum(all_RezN[iGr][hhhx]),(arr_z),NNew,1)
                ...
                all_RezNM[iGr][hhh]=(all_RezNM[iGr][hhh-1]*hhh+arr_RezN[iGr])/(hhh+1) 
